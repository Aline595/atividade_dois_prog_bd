...
print("Usuarios interresados no genero masculino")
print(data_scientists_interessados_em("masculino"))
print("Usuarios interresados no genero feminino")
print(data_scientists_interessados_em("feminino"))
print("Usuarios interresados em ambos os generos")
print(data_scientists_interessados_em("ambos"))
print("Usuarios interresados no genero nenhum")
print(data_scientists_interessados_em("nenhum"))
"""
for user in users:
  user["interessado_em"] = "."
...
print("Usuario com interesse de genero em comum")
...
print("Usuario com interesses de conteudo e genero em comum")
